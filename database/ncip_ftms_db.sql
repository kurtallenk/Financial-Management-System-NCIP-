...
INSERT INTO `activity` (`activity_id`, `activity`, `activity_time`, `activity_date`, `action`) VALUES
(19, 'Added Test Project 1 GAS on GAS', '20:23:41', '2021-08-17', 'Add'),
(20, 'Added KURT NEW on GAS', '22:46:23', '2021-08-19', 'Add'),
(21, 'Added OP NEW on OPERATIONS', '22:48:22', '2021-08-19', 'Add'),
(22, 'Added KURT on GAS', '16:59:36', '2021-08-26', 'Add'),
(23, 'Added DV #: 231213e. Status: Pending', '05:19:33', '2021-09-03', ''),
(24, 'Added DV #: 01231092390. Status: Pending', '05:26:03', '2021-09-03', ''),
(25, 'Changed Status DV#: dv_id. Status: Pending', '14:26:20', '2021-09-12', ''),
(26, 'Changed Status DV#: dv_id. Status: Pending', '14:26:22', '2021-09-12', ''),
(27, 'Changed Status DV#: 2. Status: Done', '14:26:44', '2021-09-12', ''),
(28, 'Changed Status DV#: 1231092390. Status: Done', '14:32:05', '2021-09-12', 'Add'),
(29, 'Changed Status DV#: 1231092390. Status: Pending', '04:18:26', '2021-09-24', 'Add'),
(30, 'Changed Status DV#: 1231092390. Status: Done', '04:29:44', '2021-09-24', 'Add'),
(31, 'Added ORS with Serial Number: 03262017', '11:11:31', '2021-09-24', 'Add');
...
(48, '20201010-00', 'Due to BIR', 'Liabilities', 'Due to BIR'),
(49, '20201010-01', 'Due to BIR - CWT', 'Liabilities', 'Due to BIR'),
(50, '20201010-02', 'Due to BIR - VAT (5%)', 'Liabilities', 'Due to BIR'),
(51, '20201010-03', 'Due to BIR - PT (3%)', 'Liabilities', 'Due to BIR'),
(52, '20201010-04', 'Due to BIR - EWT on Goods (1%)', 'Liabilities', 'Due to BIR'),
(53, '20201010-05', 'Due to BIR - EWT on Services (2%)', 'Liabilities', 'Due to BIR'),
(54, '20201010-06', 'Due to BIR - EWT (10,15%)', 'Liabilities', 'Due to BIR'),
(55, '20201010-07', 'Due to BIR - EWT on Rentals (5%)', 'Liabilities', 'Due to BIR'),
...
CREATE TABLE `disbursement` (
  ...
  `dv_number` int(11) NOT NULL,
  `payment_method` varchar(155) NOT NULL,
  `payment_method_uacs` varchar(255) NOT NULL,
  `tax_id` int(11) NOT NULL,
  `tax_percent` int(11) NOT NULL,
  `tax_uacs` varchar(255) NOT NULL,
  `card_number` varchar(255) NOT NULL,
  `card_name` varchar(255) NOT NULL,
  `bank_name` varchar(255) NOT NULL,
  `dv_status` varchar(151) NOT NULL,
  `dv_date` date NOT NULL,
  `dv_date_added` date NOT NULL,
  `dv_date_updated` date NOT NULL,
  `dv_amount_gross` int(11) NOT NULL,
  `dv_amount_tax` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `disbursement` (`dv_id`, `ors_id`, `dv_number`, `payment_method`, `payment_method_uacs`, `tax_id`, `tax_percent`, `tax_uacs`, `card_number`, `card_name`, `bank_name`, `dv_status`, `dv_date`, `dv_date_added`, `dv_date_updated`, `dv_amount_gross`, `dv_amount_tax`) VALUES
(2, 13, 231213, 'MDS', '10104040-00', 0, 0, '', 'None', 'None', 'None', 'Done', '2021-09-03', '0000-00-00', '0000-00-00', 48000, 48000),
(3, 9, 1231092390, 'ADA', '10104040-01', 3, 0, '', '', '', '', 'Done', '2021-09-03', '0000-00-00', '0000-00-00', 78500, 74575);
...
--
-- Dumping data for table `list_of_sub_allotments`
--

INSERT INTO `list_of_sub_allotments` (`sub_allot_id`, `agency_id`, `sub_program_id`, `saa_number`, `project`, `uacs_id`, `responsibility_center`, `class_category`, `budget`) VALUES
(7, 2, 12, 1, 'TEST SUB_ALLOT', 148, 'Regional Office', 'MOOE', 100000),
(8, 2, 12, 2, 'TEST SUB 2', 125, 'Regional Office', 'MOOE', 50000),
(9, 1, 11, 3, 'TEST SUB 3', 125, 'Regional Office', 'MOOE', 50000),
(10, 2, 12, 3, '', 125, 'Regional Office', 'MOOE', 20000),
(11, 1, 11, 66, 'TEST SUB_ALLOT', 125, 'Regional Office', 'MOOE', 50000);
...
INSERT INTO `ors` (`ors_id`, `serial_number`, `payee`, `project`, `date_added`, `date_updated`) VALUES
(9, '01231092390', 'Marco', 'Project_M', '2021-07-26', '2025-11-13'),
(13, '231213e', 'Kurt', 'Project_K', '2021-08-16', '2025-11-12'),
(15, '03262017', 'Maku', 'Hahaha', '2021-09-24', '2025-11-04');

-- --------------------------------------------------------

--
-- Table structure for table `ors_particulars`
--

CREATE TABLE `ors_particulars` (
  `ors_particulars_id` int(11) NOT NULL,
  `ors_id` int(11) NOT NULL,
  `sub_program_id` int(11) NOT NULL,
  ...
  `particulars_amount` int(11) NOT NULL,
  `date_added` date NOT NULL,
  `date_updated` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `ors_particulars`
--

INSERT INTO `ors_particulars` (`ors_particulars_id`, `ors_id`, `sub_program_id`, `particulars`, `uacs_id`, `responsibility_center`, `class_category`, `allotment`, `particulars_amount`, `date_added`, `date_updated`) VALUES
(20, 9, 2, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has su', 36, 'Apayao', 'MOOE', 0, 50000, '2021-07-26', '0000-00-00'),
(26, 9, 2, 'TEST', 23, 'Benguet', 'MOOE', 3, 28500, '2021-08-17', '2021-08-17'),
(27, 13, 2, 'TEST', 14, 'Baguio', 'MOOE', 0, 48000, '2021-08-17', '2021-09-02');
...
CREATE TABLE `program` (
  ...
  `program_accronym` varchar(155) NOT NULL,
...
INSERT INTO `program` (`program_id`, `agency_id`, `program_name`, `program_accronym`, `program_budget`) VALUES
(1, 1, 'General Administration and Support', 'GAS', 0),
(2, 1, 'Administration of Personnel Benefits', 'APB', 0),
(3, 2, 'Policy Formulation, Planning and Coordination of Programs and Projects', 'PFPCPP', 0),
(4, 3, 'Ancestral Domain / Land Security and Development Program', 'Program I', 0),
(5, 3, 'Human, Socio-economic and Ecology Development and Protection Program', 'Program II', 0),
(6, 3, 'Indigenous Peoples Rights of Protection Program', 'Program III', 0);
...
INSERT INTO `specific_budget` (`specific_budget_id`, `program_id`, `agency_id`, `project`, `uacs_id`, `responsibility_center`, `allotment`, `class_category`, `specific_budget_amount`) VALUES
(74, 1, 1, 'Test GAs', 1, 'Baguio', 0, 'MOOE', 50000),
(80, 4, 3, 'test0506_eee', 2, 'Regional Office', 0, 'MOOE', 100000),
(82, 4, 3, 'TEST_AGAIN_OPERATIONS', 1, 'Regional Office', 0, 'MOOE', 50000),
(83, 1, 1, 'Test Project', 2, 'Regional Office', 0, 'MOOE', 50000),
(92, 3, 2, 'TEST STO 52 e', 1, 'Regional Office', 0, 'MOOE', 30000),
(99, 3, 2, 'TEST_AGAIN_STO', 2, 'Regional Office', 0, 'MOOE', 50000),
(100, 3, 2, 'TEST_AGAIN', 1, 'Regional Office', 0, 'MOOE', 60000),
(101, 6, 3, 'TEST_OP_Indigenouss', 12, 'Regional Office', 0, 'MOOE', 50000),
(102, 5, 3, 'TEST_HUMAN', 2, 'Regional Office', 0, 'MOOE', 100000),
(109, 3, 2, 'Kurt Stoo', 125, 'Regional Office', 0, 'MOOE', 50000),
(118, 3, 2, 'TEST TEST', 125, 'Regional Office', 0, 'MOOE', 100000),
(121, 1, 1, 'KURT', 125, 'Regional Office', 0, 'MOOE', 50000),
(122, 1, 1, 'Hahaha', 125, 'Regional Office', 0, 'MOOE', 20000),
(123, 3, 2, 'KURT_OP', 125, 'Regional Office', 0, 'MOOE', 20000),
(124, 3, 2, 'KURT_STO', 125, 'Regional Office', 0, 'MOOE', 50000),
(125, 1, 1, 'KURT', 125, 'Regional Office', 0, 'MOOE', 50000),
(127, 4, 3, 'KURT', 125, 'Regional Office', 0, 'MOOE', 50000),
(128, 4, 3, 'KURT333', 125, 'Regional Office', 0, 'MOOE', 50000),
(129, 1, 1, 'Test Project 1 GAS', 125, 'Baguio', 0, 'MOOE', 20000),
(130, 1, 1, 'KURT NEW', 16, 'Regional Office', 0, 'MOOE', 60000),
(131, 4, 3, 'OP NEW', 99, 'Regional Office', 0, 'MOOE', 30000),
(132, 1, 1, 'KURT', 70, 'Regional Office', 0, 'MOOE', 50000);
...
CREATE TABLE `sub_program` (
  ...
  `sub_program_accronym` varchar(155) NOT NULL,
...
INSERT INTO `sub_program` (`sub_program_id`, `agency_id`, `program_id`, `sub_program_name`, `sub_program_accronym`, `sub_program_budget`) VALUES
(1, 3, 4, 'Ancestral Domain / Land Recognition', 'ADO', 0),
(2, 3, 4, 'Assistance of Ancestral Domain Sustainable Development and Protection Plan (ADSDPP) Formulation', 'ADSDPP', 0),
(3, 3, 5, 'Culturally Appropriate / Responsive and Gender Sensitive Socio-economic and Ecology Development and Protection Services', 'SECD', 0),
(4, 3, 5, 'IP Education and Advocacy Services', 'IPED', 0),
(5, 3, 5, 'IP Culture Services', 'CULTURE', 0),
(6, 3, 5, 'IP Health Services', 'HEALTH', 0),
(7, 3, 6, 'Gender and Rights-based Services', 'GRBS', 0),
(8, 3, 6, 'IP Rights Advocacy and Monitoring of Treaty Obligations', 'IPRAMTO', 0),
(9, 3, 6, 'Legal Services', 'LEGAL', 0),
(10, 3, 6, 'Adjudication Services', 'ADJU', 0),
(11, 1, 1, 'GAS', 'GAS', 0),
(12, 2, 3, 'STO', 'STO', 0);
...
INSERT INTO `sub_program_budget` (`sub_program_budget_id`, `agency_id`, `program_id`, `sub_program_id`, `project`, `uacs_id`, `responsibility_center`, `allotment`, `class_category`, `budget`) VALUES
(6, 3, 4, 1, 'TEST STO 52 e sub', 1, 'Regional Office', 0, 'MOOE', 10000),
(8, 3, 6, 10, 'TEST OPR ee', 125, 'Regional Office', 0, 'MOOE', 10000),
(9, 3, 6, 9, 'TEST OPR 531', 125, 'Regional Office', 0, 'MOOE', 40000),
(23, 3, 4, 1, 'KURT', 125, '', 0, 'MOOE', 10000);

-- --------------------------------------------------------

--
-- Table structure for table `sub_program_rc`
--

CREATE TABLE `sub_program_rc` (
  `sub_program_rc_id` int(11) NOT NULL,
  `sub_program_budget_id` int(11) NOT NULL,
  `rc` varchar(155) NOT NULL,
  `rc_budget` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `sub_program_rc`
--

INSERT INTO `sub_program_rc` (`sub_program_rc_id`, `sub_program_budget_id`, `rc`, `rc_budget`) VALUES
(10, 9, 'Regional Office', 20000),
(15, 6, 'Regional Office', 10000),
(16, 9, 'Regional Office', 20000),
(31, 8, 'Ifugao', 10000),
(33, 23, 'Baguio', 10000);
...
--
-- Table structure for table `uacs_bir`
--

CREATE TABLE `uacs_bir` (
  `uacs_bir_id` int(11) NOT NULL,
  `chart_account_id` int(11) NOT NULL,
  `uacs_number` varchar(255) NOT NULL,
  `chart_account_title` varchar(255) NOT NULL,
  `tax` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `uacs_bir`
--

INSERT INTO `uacs_bir` (`uacs_bir_id`, `chart_account_id`, `uacs_number`, `chart_account_title`, `tax`) VALUES
(1, 48, '20201010-00', 'Due to BIR', 5),
(2, 49, '20201010-01', 'Due to BIR - CWT', 5),
(3, 50, '20201010-02', 'Due to BIR - VAT (5%)', 5),
(4, 51, '20201010-03', 'Due to BIR - PT (3%)', 3),
(5, 52, '20201010-04', 'Due to BIR - EWT on Goods (1%)', 1),
(6, 53, '20201010-05', 'Due to BIR - EWT on Services (2%)', 2),
(7, 54, '20201010-06', 'Due to BIR - EWT (10,15%)', 15),
(8, 55, '20201010-07', 'Due to BIR - EWT on Rentals (5%)', 5);
...
INSERT INTO `user` (`user_id`, `name`, `username`, `password`, `position`, `authorization_id`) VALUES
(1, 'Kurty', 'admin', '$2y$10$FVggmkR2SJc8OlRoPoTdfOeWLxun8wgM9qtPAzAWThiHT35Go1i42', 'Administrator', 1),
(2, 'Cashy', 'cashier1', '$2y$10$DKrc2Ez0mEEzND2AaKECou3ZIrS2YIg.pmMZdt1eekKEZF1buZwx.', 'Cashier', 3),
(3, 'Pab', 'pab1', '$2y$10$DKrc2Ez0mEEzND2AaKECou3ZIrS2YIg.pmMZdt1eekKEZF1buZwx.', 'Budget Admin', 2);
...
CREATE TABLE `user_authorization` (
  `user_authorization_id` int(11) NOT NULL,
  `authorization_number` int(11) NOT NULL,
  `authorization_type` varchar(155) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `user_authorization` (`user_authorization_id`, `authorization_number`, `authorization_type`) VALUES
(1, 1, 'Admin'),
(2, 2, 'Programs and Budget Admin'),
(3, 3, 'Accounting');
...
--
-- Indexes for table `ors_particulars`
--
ALTER TABLE `ors_particulars`
  ADD PRIMARY KEY (`ors_particulars_id`),
  ADD KEY `ors_id` (`ors_id`),
  ADD KEY `uacs_id` (`uacs_id`),
  ADD KEY `sub_program_id` (`sub_program_id`);
...
--
-- Indexes for table `sub_program_rc`
--
ALTER TABLE `sub_program_rc`
  ADD PRIMARY KEY (`sub_program_rc_id`),
  ADD KEY `sub_program_budget_id` (`sub_program_budget_id`);

--
-- Indexes for table `uacs_bir`
--
ALTER TABLE `uacs_bir`
  ADD PRIMARY KEY (`uacs_bir_id`),
...
ALTER TABLE `user_authorization`
  ADD PRIMARY KEY (`user_authorization_id`);
...
--
ALTER TABLE `list_of_sub_allotments`
  MODIFY `sub_allot_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `ors`
--
ALTER TABLE `ors`
  MODIFY `ors_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `ors_particulars`
--
ALTER TABLE `ors_particulars`
  MODIFY `ors_particulars_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `specific_budget`
  MODIFY `specific_budget_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;

--
-- AUTO_INCREMENT for table `sub_program`
--
ALTER TABLE `sub_program`
  MODIFY `sub_program_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `sub_program_budget`
--
ALTER TABLE `sub_program_budget`
  MODIFY `sub_program_budget_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `sub_program_rc`
--
ALTER TABLE `sub_program_rc`
  MODIFY `sub_program_rc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `uacs_bir`
--
ALTER TABLE `uacs_bir`
  MODIFY `uacs_bir_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `user_authorization`
  MODIFY `user_authorization_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `disbursement`
  ADD CONSTRAINT `disbursement_ibfk_1` FOREIGN KEY (`ors_id`) REFERENCES `ors` (`ors_id`);
...
--
-- Constraints for table `ors_particulars`
--
ALTER TABLE `ors_particulars`
  ADD CONSTRAINT `ors_particulars_ibfk_1` FOREIGN KEY (`ors_id`) REFERENCES `ors` (`ors_id`),
  ADD CONSTRAINT `ors_particulars_ibfk_2` FOREIGN KEY (`uacs_id`) REFERENCES `chart_of_accounts` (`chart_account_id`),
  ADD CONSTRAINT `ors_particulars_ibfk_3` FOREIGN KEY (`sub_program_id`) REFERENCES `sub_program` (`sub_program_id`);
...
--
-- Constraints for table `sub_program_rc`
--
ALTER TABLE `sub_program_rc`
  ADD CONSTRAINT `sub_program_rc_ibfk_1` FOREIGN KEY (`sub_program_budget_id`) REFERENCES `sub_program_budget` (`sub_program_budget_id`);

--
-- Constraints for table `uacs_bir`
--
ALTER TABLE `uacs_bir`
  ADD CONSTRAINT `uacs_bir_ibfk_1` FOREIGN KEY (`chart_account_id`) REFERENCES `chart_of_accounts` (`chart_account_id`);

--
-- Constraints for table `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`authorization_id`) REFERENCES `user_authorization` (`user_authorization_id`);
COMMIT;
